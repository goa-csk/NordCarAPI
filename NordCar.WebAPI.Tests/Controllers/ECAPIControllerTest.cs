...
namespace NordCar.WebAPI.Tests.Controllers
{
    ...
    public class ECAPIControllerTest
    {
        ...
        {
            //Act
            var response = controller.GetLocations("ECBOOK");
            //Assert
            Assert.IsNotNull(response);
        }
        ...
        /// </summary>
        [TestMethod]
        public void GetLocations_Country_CarGroupId()
        {
            //Act
            var response = controller.GetLocations("ECBOOK","US","X3");
            //Assert
            Assert.IsNotNull(response);
        }
        #endregion
        ...
        public void GetAvailableCars_Today_ALL()
        {
            ...
            var pickDropInfo = new NordCar.WebAPI.Models.EC.PickDropInfo() { CountryId = "DK", PickUp = pickUp, DropOff = dropOff, CarTypeId="", CarGroupId = "" };
            string age = "28";
            //Act
        ...
        public void GetAvailableCars_location29()
        {
            ...
            var pickUp = new NordCar.WebAPI.Models.EC.Trip() { LocationId = "12", Date = Helpers.ConvertDateTimeToNovicellDateString(DateTime.Now.AddDays(1) ), Time = "800" };//Helpers.ConvertDateTimeToNovicellTime(DateTime.Now) };
            var dropOff = new NordCar.WebAPI.Models.EC.Trip() { LocationId = "60", Date = Helpers.ConvertDateTimeToNovicellDateString(DateTime.Now.AddDays(15)), Time = "800" }; //Helpers.ConvertDateTimeToNovicellTime(DateTime.Now) };
  ...
  "Basic": {
    ...
    "StepNr": ""
        ...
        public void MakeReservation()
        {
            ...
            var pickUp = new NordCar.WebAPI.Models.EC.Trip() { LocationId = "4", Date = Helpers.ConvertDateTimeToNovicellDateString(DateTime.Now.AddDays(1)), Time = Helpers.ConvertDateTimeToNovicellTime(DateTime.Now) };
            var dropOff = new NordCar.WebAPI.Models.EC.Trip() { LocationId = "4", Date = Helpers.ConvertDateTimeToNovicellDateString(DateTime.Now.AddDays(5)), Time = Helpers.ConvertDateTimeToNovicellTime(DateTime.Now) };
            var basic = new BasicStructure1() { BookTypes = "CARLSBERGVIKAR" };
    ...
    "ExpiryDate": ""
        ...
        *******************************************/
        ...
        public void CreateMyAccount()
        {
            ...
            var driver = new NordCar.WebAPI.Models.EC.Driver() { BirthDay = "08-02-1971", BirthCity = "Aarhus", BirthCountry = "Danmark", LicenseNumber = "33345543750", IssueDate = "08-06-1989", ExpiryDate = "08-02-2041", IssueCountry="Danmark" };
            ...
            account.Email = "csk11@goapplicate.com";
        ...
        public void CreateMyAccount_secrets()
        {
            var persacc = new NordCar.WebAPI.Models.EC.PersonalAccount();
            var account = new NordCar.WebAPI.Models.EC.Person();
            var driver = new NordCar.WebAPI.Models.EC.Driver() { BirthDay = "08-02-1971", BirthCity = "Aarhus", BirthCountry = "Danmark", LicenseNumber = "1234554326000", IssueDate = "08-06-1989", ExpiryDate = "08-02-2041", IssueCountry = "Danmark" };
            ...
            var friq = new NordCar.WebAPI.Models.EC.FrequentTravelerProgram() { Id = "0", CardNumber = "", ExpiryDate = "" };
            var basic = new BasicStructure1() { IPAddress = "34.34.34.34" };
            //Act
            account.Title = "Mr"; //Mr and Mrs
            account.Gender = "Male"; //Male and Female
            account.FirstName = "Claus";
            ...
            account.PostCode = "8464";
            account.Country = "Danmark";
            account.Email = "csk5@goapplicate.com";
            account.AccountType = "1";
            account.Phone = "22105256";
        ...
        public void Login_Claus()
        {
            ...
            var basic = new BasicStructure1() { };
            var logininfo = new NordCar.WebAPI.Models.EC.LoginInfo() { UserName = "csk11@goapplicate.com", Password = "fisk20fisk21", LoginType = Models.EC.LoginType.Personal };
            //Act
        ...
        [TestMethod]
        public void Login_NytLogin_Claus()
        {
            var basic = new BasicStructure1() { };
          
            var logininfo = new NordCar.WebAPI.Models.EC.LoginInfo() { UserName = "910361", Password = "Test4321", LoginType = Models.EC.LoginType.Personal};
            logininfo.Basic = basic;
            //Act
            //var response = controller.Login("csk@goapplicate.com", "fisk6fisk7");
            var response = controller.Login(logininfo);
        ...
        [TestMethod]
        public void Login_NytLogin_SOS()
        {
            var basic = new BasicStructure1() { };
            var logininfo = new NordCar.WebAPI.Models.EC.LoginInfo() { UserName = "199696", Password = "test1234", LoginType = Models.EC.LoginType.Company };
        ...
        {
            var logininfo = new NordCar.WebAPI.Models.EC.LoginInfo() { UserName = "50675", Password = "19091948", LoginType = Models.EC.LoginType.Company };
            var basic = new BasicStructure1() { };
            //Act
            var response = controller.Login(logininfo);
        ...
        {
            var basic = new BasicStructure1(){ BookTypes= BookTypes.ECBOOK.ToString(), Language = "DK", CustomerId = "910361"};
            var logininfo = new NordCar.WebAPI.Models.EC.LoginInfo() { UserName = "199696", Password = "", LoginType = Models.EC.LoginType.Agreement};
        ...
        public void ModifyMyAccount_CountryEmpty()
        {
            ...
            account.PostCode = "8464";
            account.Country = "";
            account.Email = "csk2@goapplicate.com";
            account.AccountType = "1";
            account.Phone = "22105256";
    ...
    #region 45 CheckPromotionCode
      ...
      /// <summary>
        ...
        public void CheckPromotionCode()
        {
            ...
            var basic = new BasicStructure1() { BookTypes = "ECBOOK", VoucherCode = promotionCode };
